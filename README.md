...
☢️ [Why you should **avoid** buying this pre-built from Flight Tracker LED](https://colinwaddell.com/articles/flight-tracker-led-ripoff-part-2-its-so-much-worse) (It comes with hidden remote access enabled allowing the seller to access your home network)
